...
function AuthForm({ socialProviders }: AuthFormProps) {
...
export function AuthFormWithSearchParams({ socialProviders }: AuthFormProps) {
  return (
    <Suspense>
      <AuthForm socialProviders={socialProviders} />
    </Suspense>
  );
}
